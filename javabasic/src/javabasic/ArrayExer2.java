...
//			System.out.printf("%10d %10.2f %10s",99999,3.141592,"hello");
		...
		//		 강감찬   90  80  70
		//		 이순신   80  70  60
//		String[] nameArr = {"홍길동", "강감찬", "이순신"}; //string 값으로 이름 출력
//		int[][] scoreArr = {						  //2차원 배열 시작
//				{100,90,80},						  
//				{90,80,70},
//				{80,70,60}
//		};
//		System.out.printf("\n%5s %4s %3s %3s","이름","국어","영어","수학"); //문자열 출력
//			
//		int nameArrLeng = nameArr.length; 			   //nameArrLeng에 3값 저장
//		int scoreArrLeng = scoreArr.length;			   //scoreArrLeng에 1값 저장
